...
{
    public static class otf20SampleClassGenerator
    {
        ...
        public static void GenerateSampleMessages(string targetFolder)
        {
			...
			ExportSampleFiles(sample_Message_Container_PreNotification(), targetFolder, "sample_Message_Container_PreNotification");
			ExportSampleFiles(sample_Message_Container_PreNotification_StatusUpdate(), targetFolder, "sample_Message_Container_PreNotification_StatusUpdate");

			//Status updates
			ExportSampleFiles(sample_Message_Container_StatusUpdate_Storage_Arrival(), targetFolder, "sample_Message_Container_StatusUpdate_Storage_Arrival");
			ExportSampleFiles(sample_Message_Container_StatusUpdate_Storage_Available(), targetFolder, "sample_Message_Container_StatusUpdate_Storage_Available");
			ExportSampleFiles(sample_Message_Container_StatusUpdate_Storage_Departure(), targetFolder, "sample_Message_Container_StatusUpdate_Storage_Departure");
			ExportSampleFiles(sample_Message_TankContainer_StatusUpdate_Cleaning(), targetFolder, "sample_Message_TankContainer_StatusUpdate_Cleaning");
			ExportSampleFiles(sample_Message_TankContainer_StatusUpdate_Heating(), targetFolder, "sample_Message_TankContainer_StatusUpdate_Heating");
			ExportSampleFiles(sample_Message_TankContainer_StatusUpdate_Inspection(), targetFolder, "sample_Message_TankContainer_StatusUpdate_Inspection");
			ExportSampleFiles(sample_Message_TankContainer_StatusUpdate_Transhipment(), targetFolder, "sample_Message_TankContainer_StatusUpdate_Transhipment");

			//Work flow
			ExportSampleFiles(sample_Message_Container_Work_Estimate(), targetFolder, "sample_Message_Container_Work_Estimate");
			ExportSampleFiles(sample_Message_Container_StatusUpdate_Work(), targetFolder, "sample_Message_Container_StatusUpdate_Work");

			//Inspection Certificates
			ExportSampleFiles(sample_Message_TankContainer_InspectionReport(), targetFolder, "sample_Message_TankContainer_InspectionReport");
		}

		static void ExportSampleFiles(object o, string targetfolder, string targetfilename)
        {
			ExportSampleFileXml(o, targetfolder, targetfilename);
			ExportSampleFileJson(o, targetfolder, targetfilename);
		}

		static void ExportSampleFileXml(object o, string targetfolder, string targetfilename)
		{
			//Prep target folder
			string targetfolder2 = string.Format("{0}\\{1}\\", targetfolder, "xml");
			if (!Directory.Exists(targetfolder2)) { Directory.CreateDirectory(targetfolder2); }

			//Export
			SerializationUtilsXml.SerializeToXml(o, string.Format("{0}{1}", targetfolder2, targetfilename));
		}

		static void ExportSampleFileJson(object o, string targetfolder, string targetfilename)
		{
			//Prep target folder
			string targetfolder2 = string.Format("{0}\\{1}\\", targetfolder, "json");
			if (!Directory.Exists(targetfolder2)) { Directory.CreateDirectory(targetfolder2); }

			//Export
			SerializationUtilsJson.SerializeToJson(o, string.Format("{0}{1}", targetfolder2, targetfilename));
		}
		#endregion
