...
REM Iterate files in DLLL subdir and put in string (since XSD.exe cannot handle * to process multiple files at once)
...
set targetXSDFileName=%CurrDirName%_autogenerated.xsd
