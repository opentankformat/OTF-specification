...
namespace otfSampleDataGenerator.sampleClasses
{
    public static class otf21SampleClasses
    {
		...
		public static void GenerateSampleMessages(string targetFolder)
        {
			...
			Utils.GenerateSamples(sample_Message_TankContainer_PreNotification(), targetFolder, "sample_Message_TankContainer_PreNotification");
			Utils.GenerateSamples(sample_Message_TankContainer_PreNotification_StatusUpdate(), targetFolder, "sample_Message_TankContainer_PreNotification_StatusUpdate");
			...
			Utils.GenerateSamples(sample_Message_TankContainer_StatusUpdate_Storage_Arrival(), targetFolder, "sample_Message_TankContainer_StatusUpdate_Storage_Arrival");
			...
			Utils.GenerateSamples(sample_Message_TankContainer_StatusUpdate_Storage_Available(), targetFolder, "sample_Message_TankContainer_StatusUpdate_Storage_Available");
			...
			Utils.GenerateSamples(sample_Message_TankContainer_StatusUpdate_Storage_Departure(), targetFolder, "sample_Message_TankContainer_StatusUpdate_Storage_Departure");
			...
			Utils.GenerateSamples(sample_Message_TankContainer_Work_Estimate(), targetFolder, "sample_Message_TankContainer_Work_Estimate");
			Utils.GenerateSamples(sample_Message_TankContainer_StatusUpdate_Work(), targetFolder, "sample_Message_TankContainer_StatusUpdate_Work");
