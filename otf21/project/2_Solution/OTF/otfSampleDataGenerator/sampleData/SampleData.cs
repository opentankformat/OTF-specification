...
namespace OTF.SampleGenerator
{
    public static class SampleData
    {
        ...
        //1A - LESSEE BASIC
        public static string Lessee_ID = "Lessee name or identifier";
        public static string Lessee_ContactName = "Arthur Fonzarelli";

        //1B - LESSEE TRANSPORT INFO
        public static string ContainerNumber = "ABCD-123456-0";
        public static string ContainerType = "20TC";

        public static string Arrival_HaulierName = "Who Transport Ltd.";
        public static string Arrival_TruckDriverName = "Keith Moon";
        public static string Arrival_TruckLicensePlate = "AA-11-BB";
        ...
        public static string Arrival_ContainerState_Compartment1_CurrentProductMainName = "Acid Oil";
        public static string Arrival_ContainerState_Compartment1_CurrentProductTradeName = "BLACK OIL 1013";
        public static string Arrival_ContainerState_Compartment1_PreviousProduct1MainName = "Acid Oil";
        public static string Arrival_ContainerState_Compartment1_PreviousProduct1TradeName = "BLACK OIL 1013";
        public static string Arrival_ContainerState_Compartment1_PreviousProduct2MainName = "Acid Oil";
        public static string Arrival_ContainerState_Compartment1_PreviousProduct2TradeName = "BLACK OIL 1013";
        public static string Arrival_ContainerState_Compartment1_PreviousProduct3MainName = "Acid Oil";
        public static string Arrival_ContainerState_Compartment1_PreviousProduct3TradeName = "BLACK OIL 1013";
        ...
        public static string Arrival_ContainerState_Compartment2_CurrentProductMainName = "Acid Oil";
        public static string Arrival_ContainerState_Compartment2_CurrentProductTradeName = "BLACK OIL 1013";
        public static string Arrival_ContainerState_Compartment2_PreviousProduct1MainName = "Acid Oil";
        public static string Arrival_ContainerState_Compartment2_PreviousProduct1TradeName = "BLACK OIL 1013";
        public static string Arrival_ContainerState_Compartment2_PreviousProduct2MainName = "Acid Oil";
        public static string Arrival_ContainerState_Compartment2_PreviousProduct2TradeName = "BLACK OIL 1013";
        public static string Arrival_ContainerState_Compartment2_PreviousProduct3MainName = "Acid Oil";
        public static string Arrival_ContainerState_Compartment2_PreviousProduct3TradeName = "BLACK OIL 1013";
        ...
        public static string Remark_PreNotification_Author = "Arthur Fonzarelli";
        public static string Remark_PreNotification = "Ayyyyyy!";
        ...
        public static string Orderflow_Container_StatusUpdate_Heating_ByDepot_StatusDescription = "ON HEAT";
        ...
        public static string Orderflow_Container_StatusUpdate_Cleaning_ByDepot_StatusDescription = "TO BE ESTIMATED";
        ...
        public static string Orderflow_Container_StatusUpdate_Inspection_ByDepot_StatusDescription = "IN Inspection";
        ...
        public static string Orderflow_Container_StatusUpdate_Available_ByDepot_StatusDescription = "AV";
        ...
        public static string Orderflow_Container_StatusUpdate_GateOut_ByDepot_StatusDescription = "OUT";
        ...
        public static string Remark_Work_Repair_Author = "Frank Black";
        public static string Remark_Work_Repair = "The Time is Near";

        //3 - LESSOR INFO (lessor, container information
        //3A - LESSOR BASIC
        public static string Lessor_ID = "Lessor name or identifier";
        ...
        public static string ContainerManufacturer = "MillenniuM Tanks Inc.";
        ...
        public static string Departure_HaulierName = "Gilnitz Transports Ltd.";
        public static string Departure_TruckDriverName = "C.G.B. Spender";
        public static string Departure_TruckLicensePlate = "10-13-X";

        //4 - INSPECTION BUREAU
        public static string MessageIdentifier_TankContainer_Inspection_MessageID = "56c03e52-2436-4573-927a-641662d4124d";
        
        public static string InspectionBureauID = "Inspection Bureau Name";
